...
class ScriptArguments:
    ...
    lora: dict = field(
        ...
        metadata={
            "help": "LoRA configuration dictionary containing rank, alpha, and dropout"
        }
    )
...
if __name__ == "__main__":
    ...
    peft_config = LoraConfig(
        ...
        target_modules=["q_proj", "k_proj", "v_proj", "o_proj"]  # 适用于LLaMA模型的设置
    )
