...
def eval_utility_in_batch_by_safeDecoding(model, expert_model, prompt_style, tokenizer, save_path = None,
                bench = 'sql_create_context', evaluator = 'rouge_1', batch_size_per_device = 16,
                system_prompt = None, max_eval_samples = -1,
                max_new_tokens = 1024, 
                do_sample = True, top_p = 0.9, temperature = 0.6, use_cache = True, top_k = 50,
                repetition_penalty = 1.0, length_penalty = 1.0,cmd_log_path = None, using_speculative = True, **kwargs):
